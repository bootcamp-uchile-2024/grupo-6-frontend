...
import { useFetchGetAddress, useFetchGeUser } from '../../hooks/useFetchUser';
...
const UserPage = () => {
    ...
    const { data: userAddress, loading: loadingAddress, error: errorAddress} = useFetchGetAddress<IDireccion[]>(configuracion.urlJsonServerBackendUsers, decodedToken.idUsuario);
