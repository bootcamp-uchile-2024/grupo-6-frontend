    ...
    return (
        <Container className=" adminAccount-container">
            ...
            <div className='adminAccount-info-container'>
                <Row className="admin-historial-pedidos">
                    <Col md={4} clas>
                        <div>
                            <h2>Historial de pedidos</h2>
                            <Button variant='primary' onClick={() => handleNavigation("/historial-pedidos")}>
                                Revisar el historal completo
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                    ...
                    <Col>
                        <div>
                            ...
                            <Button variant="primary" onClick={() => handleNavigation("/admin")}>
