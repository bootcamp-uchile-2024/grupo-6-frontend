            ...
            <section id="seccion-novedades">
                ...
                <div id="productos-novedades">
                    {librosExist ? libros.map(libro => (
                        <CajaNovedades key={libro.isbn} nombre={libro.nombre} stock={libro.stockLibro} autor={libro.autor} precio={libro.precio} isbn={libro.isbn} caratula={libro.caratula}></CajaNovedades>
                    ))
                        :
